(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('fs'), require('path'), require('@crguezl/xregexp'), require('recast'), require('@babel/core'), require('assert')) : typeof define === 'function' && define.amd ? define(['fs', 'path', '@crguezl/xregexp', 'recast', '@babel/core', 'assert'], factory) : (global = global || self, global['jison-helpers-lib'] = factory(global.fs, global.path$1, global.XRegExp, global.recast, global.babel, global.assert));
