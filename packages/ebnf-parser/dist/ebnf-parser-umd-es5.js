...
var alias_re=new XRegExp(`\\[${ID_REGEX_BASE$1}\\]`);var term_re=new XRegExp(`^${ID_REGEX_BASE$1}$`);// and collect the PERMITTED aliases: the names of the terms and all the remaining aliases
...
//
var nameref_re=new XRegExp(`(?:[$@]|##)${ID_REGEX_BASE$1}`,'g');var named_spots=nameref_re.exec(action);var numbered_spots=action.match(/(?:[$@]|##)[0-9]+\b/g);var max_term_index=list.terms.length;// loop through the XRegExp alias regex matches in `action`
