...
'use strict';function _interopDefault(ex){return ex&&typeof ex==='object'&&'default'in ex?ex['default']:ex;}var fs=_interopDefault(require('fs'));var path$1=_interopDefault(require('path'));var commander=require('commander');var XRegExp=_interopDefault(require('@gerhobbelt/xregexp'));var recast=_interopDefault(require('recast'));var babel=require('@babel/core');var assert$1=_interopDefault(require('assert'));var JSON5=_interopDefault(require('@gerhobbelt/json5'));// Return TRUE if `src` starts with `searchString`. 
