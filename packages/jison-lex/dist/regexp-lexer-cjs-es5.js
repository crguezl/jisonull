...
var assert$1 = _interopDefault(require('assert')); // Return TRUE if `src` starts with `searchString`. 
  ...
  function test_me(tweak_cb, description, src_exception, ex_callback) {
    ...
    try {
      ...
      var lexer = code_exec$1(testcode, function generated_code_exec_wrapper_regexp_lexer(sourcecode) {
        ...
        chkBugger$2(sourcecode); // babelize the source code for subsequent execution by Node:
